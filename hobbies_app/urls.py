...
urlpatterns = [
    ...
    path('hobbies/<int:hobby_id>/relate_friend/<int:friend_id>/', views.relate_friend, name='relate_friend'),
    path('hobbies/<int:hobby_id>/disconnect_friend/<int:friend_id>/', views.disconnect_friend, name='disconnect_friend'),
